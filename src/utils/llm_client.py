...
if __name__ == "__main__":
    ...
    # Example: OpenAI
    client = get_llm_client("openai", temperature=0.7)
    response = client.generate("What is the captical of UK", system_prompt="You are a helpful assistant.")
    print(f"OpenAI: {response}")
    
    # Example: Claude
    # client = get_llm_client("claude", temperature=0.7)
    # response = client.generate("Say hello!", system_prompt="You are a helpful assistant.")
    # print(f"Claude: {response}")
    
    # Example: HuggingFace Local
